    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:pt-20">
      <div className="mb-6 sm:mb-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto group px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-500 text-white text-sm sm:text-base font-medium hover:from-green-600 hover:to-emerald-600 transition-all shadow-xl shadow-green-500/30 hover:shadow-2xl hover:shadow-green-500/40 hover:-translate-y-0.5 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
        >
          {exporting ? (
            <>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-xs text-gray-400 flex-wrap">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>Заказчик: {report.customerName}</span>
                      </div>
                      {report.task.assignee && (
                        <div className="flex items-center gap-1">
                          ...
                          <span>Исполнитель: {report.task.assignee.name || report.task.assignee.email}</span>
                        </div>
                      )}
